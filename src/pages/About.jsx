    ...
    return (
        <div className="about-container">
            ...
            <p className="about-intro">
                ...
                in computer systems and a drive to create innovative and impactful solutions. I am a proud graduate 
                of the <strong>British Columbia Institute of Technology</strong>'s Computer Systems Technology program, 
                where I honed my skills in software development, problem-solving, and teamwork.
            </p>
            <div className="about-section">
                <h2>What I Do</h2>
                <p>
                    Over the years, I have worked on a variety of projects, ranging from web development to enterprise 
                    application development. My expertise includes:
                </p>
